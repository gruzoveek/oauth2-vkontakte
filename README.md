...
This package is fork of [gruzoveek/oauth2-vkontakte](https://github.com/gruzoveek/oauth2-vkontakte) and provides [Vkontakte](https://vk.com) integration for [OAuth2 Client](https://github.com/thephpleague/oauth2-client) by the League. Requires php8.
...
```php
$provider = new Gruzoveek\OAuth2\Client\Provider\Vkontakte([
    'clientId'     => '1234567',
...
### Public
```php
$provider->usersGet([1234, 56789]); // => \Gruzoveek\OAuth2\Client\Provider\User[]
$provider->friendsGet(23456);        // => \Gruzoveek\OAuth2\Client\Provider\User[]
```

### With additional data
```php
$providerAccessToken = new \League\OAuth2\Client\Token\AccessToken(['access_token' => 'iAmAccessTokenString']);
$provider->usersGet([1234, 56789], $providerAccessToken); // => \Gruzoveek\OAuth2\Client\Provider\User[]
$provider->friendsGet(23456, $providerAccessToken);        // => \Gruzoveek\OAuth2\Client\Provider\User[]
```
